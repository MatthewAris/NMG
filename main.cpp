...
int main()
{
    ...
    while (app.isOpen())
    {
        ...
        RectangleShape checkpoints[5];
        int nextCheckpoint{0};

        RectangleShape checkpoint1(Vector2f(400.0f, 20.0f));
        checkpoints[0] = checkpoint1;
        RectangleShape checkpoint2(Vector2f(400.0f, 20.0f));
        checkpoints[1] = checkpoint2;
        RectangleShape checkpoint3(Vector2f(400.0f, 20.0f));
        checkpoints[2] = checkpoint3;
        RectangleShape checkpoint4(Vector2f(400.0f, 20.0f));
        checkpoints[3] = checkpoint4;
        RectangleShape checkpoint5(Vector2f(400.0f, 20.0f));
        checkpoints[4] = checkpoint5;

        for (int i = 0; i < 5; i++){
            checkpoints[i].setFillColor(sf::Color::Green);
        }
        ...
        checkpoint1.setPosition(100-offsetX, 100-offsetY);
        app.draw(sBackground);
        app.draw(checkpoints[nextCheckpoint]);
        for(int i=0;i<N;i++)
        {
